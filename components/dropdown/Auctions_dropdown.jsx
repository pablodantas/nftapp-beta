...
import  Social_dropdown from "./Social_dropdown"
		...
		<>
			<div className={classes}>
				...
				<div
					className={
						dropdownShow
							? 'dropdown-menu-end dark:bg-jacarta-800 z-10 min-w-[200px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl show text-jacarta-500 absolute right-0'
							: 'dropdown-menu-end dark:bg-jacarta-800 z-10 min-w-[200px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl hidden text-jacarta-500 absolute right-0'
					}
				>
