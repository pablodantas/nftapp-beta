			...
			<section className="dark:bg-jacarta-800 relative py-24">
				...
				<div className="container">
							...
							return (
								...
								>
									<figure className="mr-4 shrink-0">
										<Link href={'/collection/' + itemLink}>
											<a className="relative block">
												...
												{icon && (
													<div
														className="dark:border-jacarta-600 bg-purple absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white"
									...
									<div>
										...
										<span className="dark:text-jacarta-300 text-sm">{amount} $USDT</span>
									</div>
								</div>
							);
						})}
					...
					<div className="mt-10 text-center">
						<Link href="/rankings">
							<a className="bg_button  inline-block rounded-button py-3 px-8 text-center font-semibold text-white transition-all">
								Go to Rankings
							</a>
						</Link>
					</div>
