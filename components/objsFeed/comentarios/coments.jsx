...
import Modal_coment_alert from "../modal_comment";
...
const Coments = ({
  ...
  return (
    <>
      ...
      {alert_comment && <Modal_coment_alert closeModalAlert={closeModalAlert}/>}
      {xiX ? (
                                      ...
                                      >
                                        ...
                                        {item?.error && (
                                          <small className="text-red ml-2">
                                            Error! we were unable to delete your
                                            comment
                                          </small>
                                        )}
                                      </pre>
                      ...
                      <div className="flex justify-center w-full">
                        ...
                        >
                          <textarea
                            ...
                            value={coments}
                            type="text"
                            className="border_color_grey text-jacarta-700 pt-0 pb-0 placeholder-jacarta-500 focus:ring-accent  w-400 border pl-10 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white input_border_2"
                            style={{
                              padding: "15px",
                              maxHeight: "57px",
                              resize: "none",
