...
function Modal_coment_alert({ keyModal, alert_comment, closeModalAlert }) {
      ...
      {xiX ? (
        <div className={"modal fade show block"} key={keyModal}>
          <div className="modal-dialog">
            <div
              className="modal-content dark:bg-jacarta-700 p-over_40"
              ref={ref}
              style={{
...
export default Modal_coment_alert;
