...
import ModalPostRepost from "../collectrions_upload/modal/modalPost_repost";

function Share({ keyModal, showShare, postId, post }) {
  ...
  function ShareOnTap() {
    setX(false);
    setShowElementPOST(!showElementPOST);
  }

  function ShareOnTapClose(){
    setShowElementPOST(false);
  } 

  return (
    <>
      {showElementPOST && <ModalPostRepost postIdRepost={postId} ShareOnTapClose={ShareOnTapClose} post={post}/>}
      {xiX ? (
        <div className={"modal fade show block"} key={keyModal}>
          <div className="modal-dialog">
            <div
              className="modal-content dark:bg-jacarta-700"
              ref={ref}
            ...
            >
              ...
              <div className="modal-body p-over_20">
                <div className="flex items-center flex-wrap">
                  <a
                    onClick={ShareOnTap}
                    className="cursor-pointer dark:hover:bg-jacarta-600 font-display hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-4 text-left text-sm transition-colors dark:text-white"
                  >
                  ...
                  >
                    ...
                    <span className="mt-1 inline-block">Whatsapp</span>
                  </a>
                  <a
                    className="cursor-pointer dark:hover:bg-jacarta-600 font-display hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-4 text-left text-sm transition-colors dark:text-white"
                    onClick={sharePost}
